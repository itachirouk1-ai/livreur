...
import type { ExperimentalPPRConfig } from 'next/dist/server/lib/experimental/ppr';
import type { ServerRuntime } from 'next/dist/types';
...
import type { WebpackLayerName } from 'next/dist/lib/constants';
...
import type { FallbackMode } from 'next/dist/lib/fallback';
import type { OutgoingHttpHeaders } from 'http';
import type { AppSegmentConfig } from 'next/dist/build/segment-config/app/app-segment-config';
import type { AppSegment } from 'next/dist/build/segment-config/app/app-segments';
...
import type { FunctionsConfigManifest, ManifestRoute } from 'next/dist/build';
...
export { getSupportedBrowsers } from 'next/dist/build/get-supported-browsers';
