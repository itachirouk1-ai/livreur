...
import type { ExternalObject, RefCell, NapiTurboEngineOptions, NapiSourceDiagnostic, NapiProjectOptions, NapiPartialProjectOptions, NapiCodeFrameOptions, NapiCodeFrameLocation } from 'next/dist/build/swc/generated-native';
...
export interface Project {
    ...
    hmrEvents(identifier: string, target: import('next/dist/build/swc').HmrTarget.Client): AsyncIterableIterator<TurbopackResult<Update>>;
    hmrEvents(identifier: string, target: import('next/dist/build/swc').HmrTarget.Server): AsyncIterableIterator<TurbopackResult<NodeJsHmrUpdate>>;
    hmrChunkNamesSubscribe(target: import('next/dist/build/swc').HmrTarget): AsyncIterableIterator<TurbopackResult<HmrChunkNames>>;
