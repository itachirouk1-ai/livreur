...
import type { NapiSourceDiagnostic } from 'next/dist/build/swc/generated-native';
import type { Binding, DefineEnv } from 'next/dist/build/swc/types';
export declare enum HmrTarget {
    Client = "client",
    Server = "server"
}
/**
