...
import type { NextPageContext, NextComponentType, NextApiResponse, NextApiRequest, NextApiHandler } from 'next/dist/shared/lib/utils';
import type { GetStaticPathsFallback } from 'next/dist/lib/fallback';
...
export type { NextAdapter, AdapterOutput } from 'next/dist/build/adapter/build-complete';
export type { Metadata, MetadataRoute, ResolvedMetadata, ResolvingMetadata, Viewport, ResolvingViewport, ResolvedViewport, } from 'next/dist/lib/metadata/types/metadata-interface';
export type { Instant } from 'next/dist/build/segment-config/app/app-segment-config';
export type { Instrumentation } from 'next/dist/server/instrumentation/types';
/**
