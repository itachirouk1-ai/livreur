import type { FlightRouterState, InitialRSCPayload, NavigationFlightResponse } from 'next/dist/shared/lib/app-router-types';
import { type NEXT_ROUTER_PREFETCH_HEADER, type NEXT_ROUTER_SEGMENT_PREFETCH_HEADER, type NEXT_INSTANT_PREFETCH_HEADER, NEXT_ROUTER_STATE_TREE_HEADER, NEXT_URL, RSC_HEADER, NEXT_HMR_REFRESH_HEADER, NEXT_HTML_REQUEST_ID_HEADER, NEXT_REQUEST_ID_HEADER } from 'next/dist/client/components/app-router-headers';
import { type NormalizedFlightData } from 'next/dist/client/flight-data-helpers';
import type { NormalizedSearch } from 'next/dist/client/components/segment-cache/cache-key';
