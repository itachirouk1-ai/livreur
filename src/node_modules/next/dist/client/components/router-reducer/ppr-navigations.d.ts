...
import type { CacheNode } from 'next/dist/shared/lib/app-router-types';
import type { HeadData, ScrollRef } from 'next/dist/shared/lib/app-router-types';
import { type RouteTree, type RefreshState, type FulfilledRouteCacheEntry } from 'next/dist/client/components/segment-cache/cache';
import { type PageVaryPath } from 'next/dist/client/components/segment-cache/vary-path';
