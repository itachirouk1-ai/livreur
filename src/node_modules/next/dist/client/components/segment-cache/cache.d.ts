import type { FlightData, Segment as FlightRouterStateSegment } from 'next/dist/shared/lib/app-router-types';
import { type VaryParams, type VaryParamsThenable } from 'next/dist/shared/lib/segment-cache/vary-params-decoding';
import { type RSCResponse } from 'next/dist/client/components/router-reducer/fetch-server-response';
import { type PrefetchTask, type PrefetchSubtaskResult } from 'next/dist/client/components/segment-cache/scheduler';
import { type SegmentVaryPath, type PageVaryPath, type LayoutVaryPath } from 'next/dist/client/components/segment-cache/vary-path';
import type { NormalizedPathname, NormalizedSearch, RouteCacheKey } from 'next/dist/client/components/segment-cache/cache-key';
import { type UnknownMapEntry } from 'next/dist/client/components/segment-cache/cache-map';
import { type SegmentRequestKey } from 'next/dist/shared/lib/segment-cache/segment-value-encoding';
import type { FlightRouterState } from 'next/dist/shared/lib/app-router-types';
import { type NormalizedFlightData } from 'next/dist/client/flight-data-helpers';
import { FetchStrategy } from 'next/dist/client/components/segment-cache/types';
import { type NavigationSeed } from 'next/dist/client/components/segment-cache/navigation';
/**
