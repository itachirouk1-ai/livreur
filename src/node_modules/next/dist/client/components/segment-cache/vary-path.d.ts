...
import type { NormalizedPathname, NormalizedSearch, NormalizedNextUrl } from 'next/dist/client/components/segment-cache/cache-key';
import type { RouteTree } from 'next/dist/client/components/segment-cache/cache';
import { type FallbackType } from 'next/dist/client/components/segment-cache/cache-map';
type Opaque<T, K> = T & {
    __brand: K;
};
/**
