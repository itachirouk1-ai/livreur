...
/>
      ...
      <div className="mx-auto max-w-7xl px-2 py-4 sm:px-2 sm:py-4 relative z-10">
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 xl:gap-10 mb-12 mt-8"
        >
          <motion.div variants={itemVariants}>
            <h4 className="text-center relative mb-6 inline-block text-center text-2xl md:text-4xl font-extrabold tracking-tight bg-gradient-to-r from-orange-500 via-red-500 to-pink-600 bg-clip-text text-transparent after:absolute after:-bottom-3 after:left-1/2 after:-translate-x-1/2 after:h-1 after:w-20 after:rounded-full after:bg-gradient-to-r after:from-orange-500 after:via-red-500 after:to-pink-600">
          ...
          <motion.div variants={itemVariants}>
            <h4 className="relative mb-4 inline-block text-lg font-bold bg-gradient-to-r from-orange-500 via-red-500 to-red-700 bg-clip-text text-transparent after:absolute after:-bottom-2 after:left-0 after:h-1 after:w-12 after:rounded-full after:bg-gradient-to-r after:from-orange-500 after:to-red-600">
        ...
        <div className="border-t border-slate-200 dark:border-slate-800 pt-8">
          ...
          >
            <Button
              ...
              className="mt-0 w-full h-11 sm:h-12 rounded-full bg-gradient-to-r from-red-900 via-red-500 to-pink-900 px-4 sm:px-6 text-2xl sm:text-base font-bold text-white shadow-[0_12px_30px_rgba(16,185,129,0.35)] hover:shadow-[0_16px_36px_rgba(16,185,129,0.45)] transition-all hover:scale-[1.02]"
            >
              <Icon
                icon="logos:whatsapp-icon"
                className="mr-2 h-8 w-8 size-auto"
