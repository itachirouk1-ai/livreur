    ...
    <section className="mx-auto mt-20 sm:mt-32 max-w-7xl px-2 sm:px-0">
      ...
      >
        <h2 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-[-0.03em] text-slate-950 dark:text-white">
          Nous Livrons <br />
          <span className="bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 bg-clip-text text-transparent">Tout Partout</span>
        </h2>
        <p className="mt-3 sm:mt-4 max-w-2xl text-base sm:text-lg text-slate-600 dark:text-slate-300 mx-auto">
          Marrakech : chacun à votre domicile !
        </p>
      </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="relative flex h-56 sm:h-72 flex-col items-center justify-center p-6 sm:p-8 text-center">
                  ...
                  <h3 className="mt-4 sm:mt-6 text-xl sm:text-3xl font-bold text-white drop-shadow-lg">{service.title}</h3>
              ...
              <Button className="mt-3 sm:mt-4 w-full h-11 sm:h-12 rounded-full bg-gradient-to-r from-green-500 via-emerald-500 to-teal-600 px-4 sm:px-6 text-sm sm:text-base font-bold text-white shadow-[0_12px_30px_rgba(16,185,129,0.35)] hover:shadow-[0_16px_36px_rgba(16,185,129,0.45)] transition-all hover:scale-[1.02]">
                <svg className="mr-2 h-5 w-5 fill-current inline" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
